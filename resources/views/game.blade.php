            ...
            <div class="content">
                ...
                <form id="higherlower">
                    ...
                    @if ($lives > 0 && $cards_left > 0)
                        ...
                        <a href="{{ route('higher') }}" class="btn btn-primary" role="button">Higher</a>&nbsp;<a href="{{ route('lower') }}" class="btn btn-success" role="button">Lower</a>

                    @endif

                    <br/><br/><a href="{{ route('shuffle') }}" class="btn btn-warning btn-xs" role="button">Shuffle Deck</a>
